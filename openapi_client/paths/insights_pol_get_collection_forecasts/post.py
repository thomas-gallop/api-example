...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["collection_address", "percentiles", "voltype", "horizon", "frequency", "dist", "start_date", "end_date", "return_price_forecasts", "alpha", "rept_curr", "exclude_wash", "arch_params", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["collection_address", "percentiles", "voltype", "horizon", "frequency", "dist", "start_date", "end_date", "return_price_forecasts", "alpha", "rept_curr", "exclude_wash", "arch_params", ], str]):
        return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_pol_collection_forecasts_oapg(
        self,
...
class GetPolCollectionForecasts(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_pol_collection_forecasts(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_pol_collection_forecasts(
        ...
        return self._get_pol_collection_forecasts_oapg(
            body=body,
