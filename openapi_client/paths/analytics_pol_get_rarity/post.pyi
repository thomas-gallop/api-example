...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["collection_address", "weights", "token_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["collection_address", "weights", "token_id", ], str]):
...
class GetPolRarity(BaseApi):
    ...
    def get_pol_rarity(
        ...
        return self._get_pol_rarity_oapg(
            body=body,
