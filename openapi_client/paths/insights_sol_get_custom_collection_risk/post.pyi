...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["collection_tag", "holding_period", "percentiles", "amount", "dist", "start_date", "end_date", "wins_outliers", "risk_free_rate", "frequency", "rept_curr", "exclude_wash", "drawdown", "arc_params", "gar_params", "har_params", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["collection_tag", "holding_period", "percentiles", "amount", "dist", "start_date", "end_date", "wins_outliers", "risk_free_rate", "frequency", "rept_curr", "exclude_wash", "drawdown", "arc_params", "gar_params", "har_params", ], str]):
        return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_sol_custom_collection_risk_oapg(
        self,
...
class GetSolCustomCollectionRisk(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_sol_custom_collection_risk(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_sol_custom_collection_risk(
        ...
        return self._get_sol_custom_collection_risk_oapg(
            body=body,
