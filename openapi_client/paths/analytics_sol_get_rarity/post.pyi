...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["collection_tag", "mint_address", "weights", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["collection_tag", "mint_address", "weights", ], str]):
...
class GetSolRarity(BaseApi):
    ...
    def get_sol_rarity(
        ...
        return self._get_sol_rarity_oapg(
            body=body,
