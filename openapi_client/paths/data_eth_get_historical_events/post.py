    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class event_type(
                ...
                @schemas.classproperty
                def CANCEL_LIST(cls):
                    return cls("cancel_list")
                
                @schemas.classproperty
                def CANCEL_OFFER(cls):
                    return cls("cancel_offer")
            __annotations__ = {
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_eth_historical_events_oapg(
        self,
...
class GetEthHistoricalEvents(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_eth_historical_events(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_eth_historical_events(
        ...
        return self._get_eth_historical_events_oapg(
            body=body,
