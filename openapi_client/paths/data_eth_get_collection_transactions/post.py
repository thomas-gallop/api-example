...
class SchemaForRequestBodyApplicationJson(
        ...
        class properties:
            ...
            class page_size(
                ...
                def POSITIVE_1000(cls):
                    return cls(1000)
            start_block_number = schemas.IntSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["start_block_number"]) -> MetaOapg.properties.start_block_number: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["collection_address", "page", "page_size", "start_block_number", "start_date", "end_date", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["start_block_number"]) -> typing.Union[MetaOapg.properties.start_block_number, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["collection_address", "page", "page_size", "start_block_number", "start_date", "end_date", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        start_block_number: typing.Union[MetaOapg.properties.start_block_number, decimal.Decimal, int, schemas.Unset] = schemas.unset,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_eth_collection_transactions_oapg(
        self,
...
class GetEthCollectionTransactions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_eth_collection_transactions(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_eth_collection_transactions(
        ...
        return self._get_eth_collection_transactions_oapg(
            body=body,
