...
class SchemaForRequestBodyApplicationJson(
    ...
    mint_address: MetaOapg.properties.mint_address
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["mint_address", "holding_period", "token_id", "dist", "start_date", "end_date", "risk_free_rate", "wins_outliers", "frequency", "rept_curr", "exclude_wash", "drawdown", "arc_params", "gar_params", "har_params", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mint_address"]) -> MetaOapg.properties.mint_address: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["mint_address", "holding_period", "token_id", "dist", "start_date", "end_date", "risk_free_rate", "wins_outliers", "frequency", "rept_curr", "exclude_wash", "drawdown", "arc_params", "gar_params", "har_params", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        mint_address: typing.Union[MetaOapg.properties.mint_address, list, tuple, ],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_sol_custom_token_risk_oapg(
        self,
...
class GetSolCustomTokenRisk(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_sol_custom_token_risk(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_sol_custom_token_risk(
        ...
        return self._get_sol_custom_token_risk_oapg(
            body=body,
