...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["collection_address", "token_id", "holding_period", "dist", "start_date", "end_date", "risk_free_rate", "wins_outliers", "frequency", "rept_curr", "exclude_wash", "drawdown", "arc_params", "gar_params", "har_params", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["collection_address", "token_id", "holding_period", "dist", "start_date", "end_date", "risk_free_rate", "wins_outliers", "frequency", "rept_curr", "exclude_wash", "drawdown", "arc_params", "gar_params", "har_params", ], str]):
        return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_eth_custom_token_risk_oapg(
        self,
...
class GetEthCustomTokenRisk(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_eth_custom_token_risk(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_eth_custom_token_risk(
        ...
        return self._get_eth_custom_token_risk_oapg(
            body=body,
