...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["collection_address", "token_id", "rept_curr", "frequency", "horizon", "alpha", "exclude_wash", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["collection_address", "token_id", "rept_curr", "frequency", "horizon", "alpha", "exclude_wash", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_pol_token_appraisal_oapg(
        self,
...
class GetPolTokenAppraisal(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_pol_token_appraisal(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_pol_token_appraisal(
        ...
        return self._get_pol_token_appraisal_oapg(
            body=body,
